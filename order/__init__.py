...
from order.controller.v1 import foo_controller

# const vars
__version__ = '0.0.1'
__email__ = 'simonbelete@gmail.com'
__title__ = 'Order Service'
__author__ = 'simonbelete'
__keywords__ = ''
__repo_name__ = 'Order Service'
__description__ = 'Order Microservices'
__project_name__ = 'Order Service'
